function b=eq(dynPrim1,dynPrim2)
%
%
b=false;
if isempty(dynPrim1)
...
if isequilibrium(dynPrim1)
    if isequilibrium(dynPrim2)
        b=length(dynPrim1.octrajectory.y)==length(dynPrim2.octrajectory.y) && ...
            all(dynPrim1.octrajectory.y-dynPrim2.octrajectory.y==0) && dynPrim1.octrajectory.arcarg-dynPrim2.octrajectory.arcarg==0; % ...
