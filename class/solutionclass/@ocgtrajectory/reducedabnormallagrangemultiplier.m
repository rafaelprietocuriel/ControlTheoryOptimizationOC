function out=reducedabnormallagrangemultiplier(ocgTrj)
%
...
out=cell(1,arcn);
for ii=1:arcn
    out{ii}=feval(ocObj,'ReducedAbnormalLagrangeMultiplier',indepvar(arcpos(1,ii):arcpos(2,ii)),depvar{ii},par,arcarg(ii));
end