...
newplot
if ~isempty(axhdl)
    h=line(docTrj,'xcoord',xcoord,'ycoord',ycoord,'zcoord',zcoord,'xdata',xdata,'ydata',ydata,'zdata',zdata,'Parent','LineStyle','none','Marker','x',axhdl,varargin{:});
else
    h=line(docTrj,'xcoord',xcoord,'ycoord',ycoord,'zcoord',zcoord,'xdata',xdata,'ydata',ydata,'zdata',zdata,'LineStyle','none','Marker','x',varargin{:});
