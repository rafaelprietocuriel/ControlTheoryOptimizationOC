function ocTrj=adapt4daesolver(ocTrj,collocationmeth,collocationnum,interpolationmeth)
...
sol=adapt4daesolver(sol,daeorder(ocTrj),collocationmeth,collocationnum,interpolationmeth);
