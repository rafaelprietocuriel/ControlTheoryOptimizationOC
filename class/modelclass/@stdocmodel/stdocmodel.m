function ocObj=stdocmodel(firstarg,Result,varargin)
%
% STDOCMODEL initializes a standard ocmodel. This object consists of the
...
if nargin>=4
    msg_onoff=varargin{2};
end
if isempty(msg_onoff)
    msg_onoff=true;
end
...
if ~isempty(ocStruct) && ~force
    ...
    if isfield(ocStruct,'pontryaginfunction')
        ocStruct=rmfield(ocStruct,'pontryaginfunction');
    end
else
