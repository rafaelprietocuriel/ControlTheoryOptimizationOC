function slMF = slicemanifold(ocObj,idx,varargin)
%
% SLICEMANIFOLD returns the slice manifold(s) stored in OCOBJ
%
% SLMF=SLICEMANIFOLD(OCOBJ) returns a cell arry of slice manifold(s) stored
% in the 'Result' field 'SliceManifold' of OCOBJ. If this filed does not
