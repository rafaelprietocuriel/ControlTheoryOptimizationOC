    ...
    if strmatch(contclass,contresultStruct{ii}.ContinuationClassification)
        ...
        if isstruct(solObj)
            for jj=contindex
                ...
                %htmp=line(ocTrj,'xdata',xvar,'xcoord',xcoord,'ydata',yvar,'ycoord',ycoord,'ocmodel',odeObj,'Tag',[tagname '_Nr:' num2str(ii) '_' num2str(jj)],varargin{:});
                htmp=plot(currentsolObj,xcoord,ycoord,'xdata',xvar,'ydata',yvar,'ocmodel',odeObj,varargin{:});
            ...
            %htmp=line(solObj,'xdata',xvar,'xcoord',xcoord,'ydata',yvar,'ycoord',ycoord,'ocmodel',odeObj,'Tag',[tagname '_Nr:' num2str(ii)],varargin{:});
            htmp=plot(solObj,xcoord,ycoord,'xdata',xvar,'ydata',yvar,'ocmodel',odeObj,varargin{:});
