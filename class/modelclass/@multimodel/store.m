...
switch fieldname
    ...
    case {'indifferencesolution4fte_mm'}
        ...
        if ~isempty(soln)
            if strcmp(fieldname,'indifferencesolution4fte_mm')
        ...
        ocResultStruct.ContinuationClassification=fieldname;
        ocResultStruct.ContinuationInformation=sout;
        %         if any(strcmp(fieldname,{'indifferencesolution4fte_mm'})) && OCMATINDIF.targettype==3
        %             sol=ocExStruct(end);
