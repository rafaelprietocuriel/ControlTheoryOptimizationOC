function ocObj=impulsemodel(firstarg,Result,varargin)
%
...
if ~isempty(ocStruct) && ~force
    if ~isstruct(ocStruct) || impulsemodeltestconsistency(ocStruct,'basicmodelstructure',symkernel)
...
ocObj.Result=Result;
ocObj=class(ocObj,'impulsemodel');