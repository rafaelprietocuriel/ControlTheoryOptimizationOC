function [mainsectionnames mandatorysectionnames]=standardmodelproperties(mainsection)
%
%
...
switch mainsection
    case 'init'
        mainsectionnames={'variable','statedynamics','objective','arcdefinition', ...
            ...
            'exogenousfunction','nonsmoothfunction','switchingcondition','optimization','exogenousdynamics'};
