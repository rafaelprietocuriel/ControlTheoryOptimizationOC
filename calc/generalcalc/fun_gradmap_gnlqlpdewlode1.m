function [u,v,w,Val,du,dv,dw,y,z,p,q,xi,theta,eta,zeta] = fun_gradmap_gnlqlpdewlode1(u,v,w,gmopt,varargin)
...
% solve primal system
for i = 1:opt.MaxIter
    [y,z,p,q] = gnlqlpdewlode1(1,opt.funF,ic,icz,opt.funPhi,opt.xmesh,opt.tspan,fpq,u,v,w,varargin{:});
...
for i = 1:opt.MaxIter % solve the adjoint system
    [xi,theta,eta,zeta] = gnlqlpdewlode1(-1,@adj_fqnlpdewode,ic,icz,BC,...
