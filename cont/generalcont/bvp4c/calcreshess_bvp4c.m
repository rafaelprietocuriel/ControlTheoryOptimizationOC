function Hes=calcreshess_bvp4c(x,y,freepar,modelpar,ode,bc,odejac,bcjac,odehess,bchess)
...
colspar=OCBVP.nN+(1:OCBVP.npar);

%Hes=spalloc(OCBVP.nN+OCBVP.nparmc,(OCBVP.nN+OCBVP.npar)*(OCBVP.nN+OCBVP.npar),(OCBVP.nN+OCBVP.npar)*(2*OCBVP.numode+OCBVP.npar)*(OCBVP.nN+OCBVP.npar));  % sparse storage
Hes=zeros(OCBVP.nN+OCBVP.nparmc,OCBVP.nN+OCBVP.npar,OCBVP.nN+OCBVP.npar);
...
for arc=1:numarc
    ...
    for ii=1:OCBVP.Nint(arc)
        ...
        Hes(rows,[cols cols + OCBVP.numode],planes)=PhiHess_yi;
        planes=planes+OCBVP.numode;
        Hes(rows,[cols cols + OCBVP.numode],planes)=PhiHess_yip1;
    ...
    colsb=cols;
    planesb=planes;
    Hes(1:OCBVP.nBCs,colsa,planesa) = d2BCdyadya(:,(arc-1)*OCBVP.numode+(1:OCBVP.numode),(arc-1)*OCBVP.numode+(1:OCBVP.numode));
    Hes(1:OCBVP.nBCs,colsa,planesb) = d2BCdyadyb(:,(arc-1)*OCBVP.numode+(1:OCBVP.numode),(arc-1)*OCBVP.numode+(1:OCBVP.numode));
    Hes(1:OCBVP.nBCs,colsb,planesa) = d2BCdybdya(:,(arc-1)*OCBVP.numode+(1:OCBVP.numode),(arc-1)*OCBVP.numode+(1:OCBVP.numode));
    Hes(1:OCBVP.nBCs,colsb,planesb) = d2BCdybdyb(:,(arc-1)*OCBVP.numode+(1:OCBVP.numode),(arc-1)*OCBVP.numode+(1:OCBVP.numode));
    Hes(1:OCBVP.nBCs,colsa,planespar) = d2BCdyadpar(:,(arc-1)*OCBVP.numode+(1:OCBVP.numode),1:OCBVP.npar);
    Hes(1:OCBVP.nBCs,colspar,planesa) = d2BCdpardya(:,1:OCBVP.npar,(arc-1)*OCBVP.numode+(1:OCBVP.numode));
    Hes(1:OCBVP.nBCs,colsb,planespar) = d2BCdybdpar(:,(arc-1)*OCBVP.numode+(1:OCBVP.numode),1:OCBVP.npar);
    Hes(1:OCBVP.nBCs,colspar,planesb) = d2BCdpardyb(:,1:OCBVP.npar,(arc-1)*OCBVP.numode+(1:OCBVP.numode));
    Hes(1:OCBVP.nBCs,colspar,planespar) = d2BCdpardpar(:,1:OCBVP.npar,1:OCBVP.npar);
    cols = cols + OCBVP.numode;
    planes=planes+OCBVP.numode;
end
Hes(:,:,OCBVP.nN+(1:OCBVP.npar))=cat(2,last_planes,last_planes2);
Hes(:,planespar,1:OCBVP.nN)=permute(last_planes,[1 3 2]);
