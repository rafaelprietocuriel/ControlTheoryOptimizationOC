function dGdy=calcreshes_bvp4c(x,y,freepar,modelpar,ode,bc,odejac,bcjac,odehess,bchess)
...
cols =1:OCBVP.numode;             % in the global Hessian
...
for ii=1:OCBVP.numarc*OCBVP.numode
    counter=counter+1;
    DGBC(counter,1)=-v(1:OCBVP.nBCs)'*d2BCdYdya(:,1:lw1,ii)*w1;
end
for ii=1:OCBVP.numarc*OCBVP.numode
    counter=counter+1;
    DGBC(counter,1)=-v(1:OCBVP.nBCs)'*d2BCdYdyb(:,1:lw1,ii)*w1;
end
for ii=1:OCBVP.npar
    dGtotpar(ii,1)=-v(1:OCBVP.nBCs)'*d2BCdYdpar(:,1:lw1,ii)*w1;
end
