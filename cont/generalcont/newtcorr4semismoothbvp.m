function [tmesh,coeff,tangent,iter]=newtcorr4semismoothbvp(tmesh0,coeff0,tangent0)
...
% THE MAIN LOOP:
PHI=OCMATCONT.operatoreq(tmesh,coeff,tangent,OCMATCONT.dae,OCMATCONT.bc,OCMATCONT.icfun);
for iter=1:OCMATCONT.OPTIONS.maxnewtiter
    if needGlobJac
        % setup and factor the global Jacobian
        DPHI=OCMATCONT.frechetder(tmesh,coeff,tangent,OCMATCONT.dae,OCMATCONT.bc,OCMATCONT.icfun,OCMATCONT.daejac,OCMATCONT.bcjac,OCMATCONT.icfunjac);
