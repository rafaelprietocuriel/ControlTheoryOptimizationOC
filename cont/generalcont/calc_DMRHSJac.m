function Jac=calc_DMRHSJac(x,y,freepar,modelpar,map,bc,ic,mapjac,bcjac,icjac)
...
if OCBVP.sumconstraint
    ...
    Jac(OCBVP.nNm1+OCBVP.nparmc-OCBVP.nICs+1:OCBVP.nNm1+OCBVP.nparmc,1:OCBVP.nNm1)=JICdy;
...
for pp=1:OCBVP.numpath
    % Left BC
    Jac(1:OCBVP.nBCs,cols) = dGdya(:,arc*OCBVP.nummap+(1:OCBVP.nummap));
...
global OCBVP
dICdp=[];
% the derivative is done with respect to the entire path, this has to be
% reflected in the the third argument.
