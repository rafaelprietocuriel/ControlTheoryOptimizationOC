function res=residualpde_bvp6c(t,y,freepar,modelpar,RHS,ode)
...
for arc = 1:OCBVP.numarc
    ...
    if OCMATCONT.OPTIONS.xyvectorized
        Yp_ip05 = ode(tip05,Yip05,FcnArgs{:});
        nfcn = nfcn + 1;
    else % not vectorized
        Yp_ip05 = zeros(OCBVP.numode,OCBVP.Nint(arc));
        for i = 1:OCBVP.Nint(arc)
            Yp_ip05(:,i) = ode(tip05(i),Yip05(:,i),FcnArgs{:});
        end
