function [Jac,M]=calc_RHSJac4LC(tmesh,y,z,freepar,modelpar,ode,bc,icfun,odejac,bcjac,icfunjac)

global OCMATCONT

switch OCMATCONT.bvpmethod
    case {'bvp4c'}
        [Jac,M]=calcresjac_bvp4c4monodromy(tmesh,y,freepar,modelpar,ode,bc,icfun,odejac,bcjac,icfunjac);
    case {'gbvp4c'}
