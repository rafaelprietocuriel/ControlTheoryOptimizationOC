function sol=initocmat_PER_P(ocObj,ocPS,parindex,varargin)
...
if isfield(sol,'parameters')
    ...
    sol.parameters=parametervalue(ocObj,parindex);
end
...
OCMATPS.varyparameterindex=parindex;
OCMATPS.targetparametervalue=targetparametervalue;
