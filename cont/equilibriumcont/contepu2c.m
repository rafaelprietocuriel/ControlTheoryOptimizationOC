function varargout=contepu2c(ocObj,ocEP,opt,varargin)
%
...
UserInfo.name='reachoptimalequilibrium';
UserInfo.state=1;
UserInfo.label='roe';
opt=setocoptions(opt,'MATCONT','Userfunctions',1,'UserfunctionsInfo',UserInfo,'UserfunctionsStop',1);

[x0,v0]=ocmatinit_U2C_EP_EP(ocObj,ocEP,varargin{:});
