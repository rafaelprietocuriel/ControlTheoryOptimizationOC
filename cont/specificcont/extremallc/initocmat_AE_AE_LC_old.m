function sol=initocmat_AE_AE_LC(ocObj,ocAsym,contcoordinate,targetvalue,opt,varargin)
%
...
fixdistanceidx=find(strcmpi(varargin,'fixdistance'));
...
sol.x=ocAsym.x;
sol.y=ocAsym.y;
sol.parameters=ocAsym.arcinterval(2:end);
