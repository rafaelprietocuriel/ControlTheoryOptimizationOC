...
if solutionindex==1
    ...
    if strcmp(OCMATCONT.continuationtype,'time')
        arctime=OCMATAE.TRJ.switchtimes;
        ...
        if OCMATAE.freeendtime
            arctime=[0 arctime freepar(OCMATAE.TRJ.endtimecoordinate)];
        else
            arctime=[0 arctime OCMATAE.TRJ.endtime];
        end
    else
        arctime=OCMATAE.TRJ.switchtimes;
        arctime(OCMATAE.freetimeindex)=freepar(OCMATAE.TRJ.freetimecoordinate);
...
if solutionindex==1
    if OCMATAE.TRJ.numarc>1
        ...
        if relarc<OCMATAE.TRJ.numarc
            if 1%any(relarc==OCMATAE.freetimeindex)
