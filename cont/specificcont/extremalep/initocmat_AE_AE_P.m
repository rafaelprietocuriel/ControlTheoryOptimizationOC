function sol=initocmat_AE_AE_P(ocObj,ocAsym,parindex,initialcoordinate,opt,varargin)
% INITOCMAT_AEP_EP initialization for asymptotic extremal calculation
% varying a parameter
%
% SOL=INITOCMAT_AEP_EP(ocObj,ocEP,contidx,targetvalue)
%
% Literature for continuation of invariant parameter dependent subspaces
% see, Pampel, Demmel, Dieci
...
[dum,OCMATAE.numstable,OCMATAE.numunstable,OCMATAE.numcenter,infoStruct]=asymptoticbc(JacobianMatrix,pathtpe,'c',ZeroDeviationTolerance);
...
OCMATAE.Q0=infoStruct.Q;%computeBase(JacobianMatrix,stableflag,OCMATAE.subspacedim);
