function sol=initocmat_AE_AE_InitHom(ocObj,ocAsym,initialcoordinate,varargin)
...
targetdiffvalueidx=find(strcmpi(varargin,'targetdiffvalue'));
if ~isempty(targetdiffvalueidx)
    targetdiffvalue=varargin{targetdiffvalueidx+1};
end
if isempty(targetdiffvalue)
    targetdiffvalue=0;
end
...
OCMATAE.startdiffvalue=norm(ocAsym.y(:,1)-ocAsym.y(:,end));
OCMATAE.targetdiffvalue=targetdiffvalue;
OCMATAE.continuationvector=targetdiffvalue-OCMATAE.startdiffvalue;
