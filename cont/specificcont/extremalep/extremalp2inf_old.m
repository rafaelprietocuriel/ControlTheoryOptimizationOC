...
if ~OCMATAE.freehorizon
    truncationtime=OCMATAE.truncationtime;
else
    truncationtime=OCMATAE.startvalue+freepar(OCMATAE.freehorizoncoord)*OCMATAE.continuationvector;
end
...
out.solverinfo.conttype='extremalp2inf';
...
try
    if contnum==1
        save([OCMATAE.basicglobalvarfilename '4extremalp2inf'],'MODELINFO')
    end
    save([OCMATAE.basicresultfilename '4extremalp2inf'],'sout','bvpout')
catch
    failed=1;
end
