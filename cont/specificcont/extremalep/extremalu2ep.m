...
out.solverinfo.conttype='extremalu2ep';
...
try
    if contnum==1
        save([OCMATAE.basicglobalvarfilename '4extremalu2ep'],'MODELINFO')
    end
    save([OCMATAE.basicresultfilename '4extremalu2ep'],'sout','bvpout')
catch
    failed=1;
end
