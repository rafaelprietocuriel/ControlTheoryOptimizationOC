function sol=initocmat_ODE_EP(ocObj,ocEP,contcoordinate,targetvalue,opt,varargin) 
%
...
[asymptoticmatrix,dum,dum,dum,infoStruct]=asymptoticbc(J,pathtype,'c',ZeroDeviationTolerance);
% if numae
%     % remove 
