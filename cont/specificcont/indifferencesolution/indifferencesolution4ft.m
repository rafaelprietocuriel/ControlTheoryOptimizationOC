...
for ii=1:OCMATINDIF.indifferenceorder
    ...
    if ii==1
        ...
        if OCMATINDIF.continuationtype==0
            initialstate(OCMATINDIF.continuationindex)=initialstate(OCMATINDIF.continuationindex)+freepar(OCMATINDIF.continuationcoordinate)*OCMATINDIF.continuationvector;
        end
        resinit=[resinit; ...
...
for ii=1:OCMATINDIF.indifferenceorder
    ...
    if OCMATINDIF.static
        modelpar(OCMATINDIF.staticparameterindex)=freepar(OCMATINDIF.staticparametercoordinate{ii});
        out.modelparameter{ii}=modelpar;
    else
