function sol=initocmat_FTE_MS(ocObj,ocTrjMP,continuationtype,continuationindex,continuationtarget,varargin)
%
...
parametervalueidx=find(strcmpi(varargin,'parametervalue'));
...
if ~isempty(parametervalueidx)
    parametervalue=varargin{parametervalueidx+1};
end
