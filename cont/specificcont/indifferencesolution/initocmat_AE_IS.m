...
if isa(ocObj,'differentialgame')
    sol=initocmat_AE_IS4differentialgame(ocObj,ocMP,varargin{:},'objectivevaluecalc',1);
    OCMATINDIF.differentialgame=true;
    return
else
    OCMATINDIF.differentialgame=false;
end
...
if objectivevaluecalc
    ...
    sol.y=sol.y(OCMATINDIF.statecostatecoordinate,:);
end
