...
if OCMATINDIF.variationalcalculation
    ...
    OCMATINDIF.variationalhamiltonian=funch{4}{6};
...
OCMATINDIF.Jext=[[OCMATINDIF.dFDO OCMATINDIF.dFDE];[OCMATINDIF.dFODO OCMATINDIF.dFODE];[OCMATINDIF.dFEDO OCMATINDIF.dFEDE]];
