...
for order=1:OCMATINDIF.indifferenceorder
    ...
    if ~isempty(OCMATINDIF.freeendtime)
        resasym=[resasym; ...
...
try
    if contnum==1
        save([OCMATINDIF.basicglobalvarfilename '4indifferencesolution4lc'],'MODELINFO')
    end
    save([OCMATINDIF.basicresultfilename '4indifferencesolution4lc'],'sout','bvpout')
catch
    failed=1;
end
