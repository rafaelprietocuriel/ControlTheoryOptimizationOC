function out=ppdeextremal2epde()
...
if OCMATPPDESD.movinghorizon
    resasym=[resasym; ...
        sqrt(sum((OCMATPPDESD.saddlepoint-depvarb(OCMATPPDESD.coeffidx(:),end)).^2))-OCMATPPDESD.distance];
end
if OCMATPPDESD.objectivevaluecalc
...
out.discretizationinfo.timeinterval=[OCMATPPDESD.initialtime freepar(OCMATPPDESD.switchtimecoord).' OCMATPPDESD.truncationtime];
out.optidentifier=[];
