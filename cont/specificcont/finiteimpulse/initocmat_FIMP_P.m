function sol= initocmat_FIMP_P(ocObj,hocTrj,parindex,varargin)
%
%
% INITOCMAT_FIMP_T
%
...
if ~isautonomous(ocObj)
    ...
    IOCMATFTE.canonicalsystemjacobianderivativetime=funch{2}{3};
end
...
sol.parameters=[sol.parameters IOCMATFTE.parametervalue(parindex)];
