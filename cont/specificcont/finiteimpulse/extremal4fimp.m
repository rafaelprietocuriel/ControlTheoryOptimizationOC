...
initialstate=IOCMATFTE.startvalue+freepar(end)*IOCMATFTE.continuationvector;
resinit=IOCMATFTE.bcinitial(X0,IOCMATFTE.initialcoordinate,initialstate,modelpar,OCMATCONT.HE.arcarg(1));
...
out.modelparameter=IOCMATFTE.parametervalue;
...
out.solverinfo.conttype='extremal4fimp';
...
out.solverinfo.startvalue=IOCMATFTE.startvalue;
out.solverinfo.initialcoordinate=IOCMATFTE.initialcoordinate;
out.solverinfo.continuationvector=IOCMATFTE.continuationvector;
...
try
    if contnum==1
        save([IOCMATFTE.basicglobalvarfilename '4extremal4fimp'],'MODELINFO')
    end
    save([IOCMATFTE.basicresultfilename '4extremal4fimp'],'sout','bvpout')
catch
    failed=1;
end
