function sol=initocmat_FIMP_AddI(ocObj,hocTrj,varargin)
%
%
...
initcontparameteridx=find(strcmpi(varargin,'initcontparameter'));
...
if ~isempty(initcontparameteridx)
    initcontparameter=varargin{initcontparameteridx+1};
end
...
sol.parameters=[sol.parameters arctime(switchtimeidx) initcontparameter];
