function sol=initocmat_FTE_T_Fund(ocObj,ocTrj,timeindex,targetvalue,initialcoordinate,varargin)
%
% initocmat_FTE_T_Fund initialization for asymptotic extremal calculation
% with corresponding fundamental solution of linearization
%
...
if isempty(ocTrj)
    ...
    % add fundamentalsolution
    tmp=eye(length(ocTrj.y));
    ocTrj.y=[ocTrj.y;tmp(:)];
