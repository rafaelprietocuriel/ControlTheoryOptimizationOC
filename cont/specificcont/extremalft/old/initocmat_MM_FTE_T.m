function sol=initocmat_MM_FTE_T(mmObj,ocTrj,continuationtype,continuationindex,continuationtarget,varargin)
%
...
addstageidx=find(strcmpi(varargin,'addstage'));
...
if ~isempty(addstageidx)
    addstage=varargin{addstageidx+1};
end
