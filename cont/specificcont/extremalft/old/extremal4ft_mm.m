...
for ii=1:OCMATFTE.numberofmodels
    ...
    if ii<OCMATFTE.numberofmodels
        respartconnect=[respartconnect; ...
            OCMATFTE.bcconnectingparts{ii}(depvara(OCMATFTE.statecostatecoord{ii},:),depvarb(OCMATFTE.statecostatecoord{ii},:),modelpar{ii},arctime,arcarg,OCMATFTE.cumsumnumarc(ii),ii)];
        if OCMATFTE.optimalswitchingtime(ii)
            respartconnect=[respartconnect; ...
                OCMATFTE.bcoptimalconnectingparts{ii}(depvara(OCMATFTE.statecostatecoord{ii},:),depvarb(OCMATFTE.statecostatecoord{ii},:),modelpar,arctime,OCMATCONT.HE.arcarg,OCMATFTE.cumsumnumarc(ii),ii)];
        end
        if OCMATFTE.objectivevaluecalc
            resconnec=[resconnec; ...
...
if OCMATFTE.findoptimalswitchingtime
    ...
    out=OCMATFTE.bcoptimalconnectingparts{solutionindex}(depvara(OCMATFTE.statecostatecoord{solutionindex},:),depvarb(OCMATFTE.statecostatecoord{solutionindex},:),modelpar,arctime,arcarg,OCMATFTE.cumsumnumarc(solutionindex),solutionindex);
else
